 ...
 * @author zmichaels
 */
public class VKThreadConstantsOld {    
    ...
    private static final ThreadLocal<VKThreadConstantsOld> INSTANCES = new ThreadLocal<>();
    ...
    public static void create(final VkDevice device) {
        INSTANCES.set(new VKThreadConstantsOld(device));
    }
    ...
    public VKThreadConstantsOld(final VkDevice device) {
        this.device = device;
    }
    
    public final VkDevice device;    

    public static VKThreadConstantsOld getInstance() {

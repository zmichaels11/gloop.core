...
public final class GL4XDriver implements Driver<
    ...
    public boolean isSparseTextureSupported() {
        ...
        return cap.OpenGL42 && cap.GL_ARB_sparse_texture;
    }
    ...
    public void bufferAllocateImmutable(GL4XBuffer buffer, long size, long bitflags) {
        ...
        if (cap.OpenGL42) {
            ...
            throw new UnsupportedOperationException("Buffer storage is required!");
        }
    }
    ...
    public void bufferInvalidateRange(GL4XBuffer buffer, long offset, long length) {
        ...
        if (cap.OpenGL43) {
            ...
            throw new UnsupportedOperationException("GL43 | ARB_invalidate_subdata not supported!");
        }
    }
    ...
    public void programSetStorage(GL4XProgram program, String storageName, GL4XBuffer buffer, long bindingPoint) {
        ...
        if (cap.OpenGL43) {
            ...
            throw new UnsupportedOperationException("GL43 | ARB_shader_storage_buffer_object is not supported!");
        }
    }
    ...
    public long textureGetPageWidth(GL4XTexture texture) {
        if(GL.getCapabilities().OpenGL42) {
            ...
            throw new UnsupportedOperationException("GL42 is required for querying sparse texture virtual page size!");
        }
    }
    ...
    public long textureGetPageHeight(GL4XTexture texture) {
        if(GL.getCapabilities().OpenGL42) {
            ...
            throw new UnsupportedOperationException("GL42 is required for querying sparse texture virtual size!");
        }
    }

...
public final class ARBDriver implements Driver<
    ...
    public static ARBDriver getInstance() {
    ...
    public boolean is64bitUniformsSupported() {
        ...
        return cap.OpenGL40 || (cap.GL_ARB_gpu_shader_fp64 && cap.GL_ARB_gpu_shader_int64);
    }
    @Override
    ...
    public boolean isDrawIndirectSupported() {
        ...
        return cap.OpenGL40 || cap.GL_ARB_draw_indirect;
    }
    @Override
    ...
    public boolean isFramebufferSupported() {
        ...
        return cap.OpenGL30 || cap.GL_ARB_framebuffer_object;
    }
    @Override
    ...
    public boolean isSamplerSupported() {
        ...
        return cap.OpenGL33 || cap.GL_ARB_sampler_objects;
    }
    @Override
    ...
    public boolean isVertexArraySupported() {
        ...
        return cap.OpenGL30 || cap.GL_ARB_vertex_array_object;
    }
    ...
    public void programSetUniformD(ARBProgram program, long uLoc, double[] value) {
        ...
        } else if (this.is64bitUniformsSupported()) {
            final int currentProgram = GL11.glGetInteger(GL20.GL_CURRENT_PROGRAM);
    ...
    public void programSetUniformMatD(ARBProgram program, long uLoc, DoubleBuffer mat) {
        if (this.isSeparateShaderObjectsSupported()) {
            ...
            throw new UnsupportedOperationException("64bit uniform values is not supported!");
        }
    }
    @Override
